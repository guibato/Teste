...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Concatenação com os.path.join
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        'ENGINE': 'djongo',
        'NAME': 'Palestra',  # Nome do banco de dados
        'CLIENT': {
            'host': 'localhost',  # Host do MongoDB local
